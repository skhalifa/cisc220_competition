...
Second, create 5 script files [scriptx1.sh, scriptx2.sh, scriptx3.sh, script4.sh, scriptx5.sh] 
write in them the following and make the files executable for user only chmod u+x script*
----------------------
#!/bin/bash
echo hello
----------------------
...
Fourth, Write a one line command using pipes to change the permission of all script files which are identified by 
having the "#!/bin/bash" line written in them to become not executable.
